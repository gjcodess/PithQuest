...
async function generateDocx() {
  ...
  const modules = [
    ...
    { num: '14', title: 'Stage 7: Flash Deep Frying & Steam Expansion', desc: 'Simulates immersion deep frying in clean vegetable oil at 180°C, triggering rapid superheated steam flash-off and 3× structural volumetric expansion.' },
    ...
    sections: [
      {
        ...
        children: [
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: 'The core processing curriculum consists of eight authentic unit operations: Stage 1 (Hydrothermal Softening) teaches the thermal inactivation of polyphenol oxidase (PPO) enzymes to halt enzymatic browning and soften cellulosic fibrous cell walls by boiling ubod strips at 100°C; Stage 2 (High-Shear Pureeing) teaches mechanical fiber homogenization using high-speed stainless steel blades to create a micro-fine pulp matrix, preventing grittiness in final cracker textures; Stage 3 (1:1 Dough Formulation) instructs students on dough rheology and starch binding, blending exactly 1:1 boiled ubod with rice flour to establish proper amylose/amylopectin ratios without excessive stickiness; Stage 4 (Precision Sheet Molding) emphasizes uniform heat and mass transfer by sheeting cracker dough to an exact 2mm thickness and stamping 50mm × 25mm rectangular blanks; Stage 5 (Atmospheric Starch Steaming) demonstrates starch gelatinization by subjecting molded blanks to atmospheric steam at 100°C for 10 minutes, swelling starch granules and stabilizing the viscoelastic network; Stage 6 (Convective Cabinet Dehydration) explores convective moisture removal, drying steamed blanks at 60–90°C until moisture drops below 10%, preparing the internal matrix for rapid vapor expansion; Stage 7 (Flash Deep Frying) demonstrates heat transfer and structural expansion, immersing dried cracker blanks into 180°C oil for 8–12 seconds, turning trapped residual moisture into superheated steam that puffs the cracker to 3× its original volume; Stage 8 (Nitrogen-Flushed Barrier Packaging) covers post-fry cooling, moisture barrier packaging, and nitrogen flushing in multi-layer foil/Kraft pouches to prevent atmospheric re-absorption and lipid auto-oxidation. Each stage begins with an instructional Checkpoint Question utilizing 1-click instant verification, illuminating the correct standard procedure and biochemical rationale before launching the interactive cooking mini-game.',
              }),
            ],
          }),
